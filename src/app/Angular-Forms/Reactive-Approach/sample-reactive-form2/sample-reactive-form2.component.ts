...
@Component({
  selector: 'app-sample-reactive-form2',
  templateUrl: './sample-reactive-form2.component.html',
  styleUrls: ['./sample-reactive-form2.component.scss']
})
export class SampleReactiveForm2Component {
